		...
		<View
			...
			<View>
				...
				<View style={{backgroundColor: bgColor}}>
					<View style={{flex: 1}}>
						<ItemComponent mainText1={'From'} mainText2={'To'} subText1={time.from} subText2={time.to} />
						<ItemComponent
							mainText1={'Hours Before Ordering'}
							mainText2={'Maximum Orders'}
						...
						<View
							...
							<View style={{flex: 0.5, marginRight: 16}}>
								<Text style={styles.mainTxt}>Not Available On Friday </Text>
								<CheckBox ticked={time.not_available_in_friday ? true : false} />
							</View>
